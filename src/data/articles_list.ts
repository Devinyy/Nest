...
export const categoryArticles: Record<string, ArticleItem[]> = {
  ...
  阅读: [
    { cover: "/icons/introduction.png", title: "年度书单与阅读方法", subdesc: "我的阅读体系与推荐书目", url: "https://xxxxxxxxxxxxxxxx", time: "2024.10.01", views: 250, category: "阅读", tags: ["阅读"] },
  ],
  摄影: [
    { cover: "/icons/introduction.png", title: "光影与故事：街拍日记", subdesc: "记录与构图的日常练习", url: "https://xxxxxxxxxxxxxxxx", time: "2024.09.15", views: 180, category: "摄影", tags: ["摄影"] },
  ],
};
